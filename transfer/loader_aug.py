...
from aug import Line_Graph_v1, Line_Graph_v2
...
class MoleculeDataset_aug(InMemoryDataset):
    def __init__(self,
        ...
        super(MoleculeDataset_aug, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    def get(self, idx):
        ...
        for key in self.data.keys:
            ...
            data[key] = item[s]
        if self.aug == 1:
            data = Line_Graph_v1(data)
        elif self.aug == 2:
            data = Line_Graph_v2(data)
        elif self.aug == 0:
            None
        return data
